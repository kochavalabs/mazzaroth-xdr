...
function CommittedTransaction() {
    return new _jsXdr2.default.Struct(["sequenceNumber", "transaction", "receiptID", "currentTransactionRoot", "signer", "signature"], [new _jsXdr2.default.UHyper(), Transaction(), ID(), Hash(), ID(), Signature()]);
}
function Input() {
