...
func Test_API_JSONMarshal(t *testing.T) {
	tests := []struct {
		...
		{ResponseTypeACCOUNT, Account{}, `{"type":9,"data":{"alias":"","authorizedAccounts":null}}`},
		{ResponseTypeHEIGHT, BlockHeight{}, `{"type":10,"data":{"height":"0"}}`},
		{ResponseTypeABI, Abi{}, `{"type":11,"data":{"version":"","functions":null}}`},
		{ResponseTypeABI, Abi{Version: "1.0", Functions: []FunctionSignature{{FunctionName: "One"}, {FunctionName: "Two"}, {FunctionName: "Three"}, {FunctionName: "Four"}, {FunctionName: "Five"}}}, `{"type":11,"data":{"version":"1.0","functions":[{"functionType":0,"functionName":"One","parameters":null,"returns":null},{"functionType":0,"functionName":"Two","parameters":null,"returns":null},{"functionType":0,"functionName":"Three","parameters":null,"returns":null},{"functionType":0,"functionName":"Four","parameters":null,"returns":null},{"functionType":0,"functionName":"Five","parameters":null,"returns":null}]}}`},
	}
...
func Test_API_JSONUnmarshal(t *testing.T) {
	tests := []struct {
		...
		{ResponseTypeACCOUNT, `{"type":9,"data":{"alias":"","authorizedAccounts":null}}`, Response{Type: ResponseTypeACCOUNT, Account: &Account{}}},
		{ResponseTypeHEIGHT, `{"type":10,"data":{"height":"0"}}`, Response{Type: ResponseTypeHEIGHT, Height: &BlockHeight{}}},
		{ResponseTypeABI, `{"type":11,"data":{"version":"1.0","functions":[]}}`, Response{Type: ResponseTypeABI, Abi: &Abi{Version: "1.0", Functions: []FunctionSignature{}}}},
		{ResponseTypeABI, `{"type":11,"data":{"version":"1.0","functions":[{"functionName": "One"},{"functionName": "Two"},{"functionName": "Three"},{"functionName": "Four"},{"functionName": "Five"}]}}`, Response{Type: ResponseTypeABI, Abi: &Abi{Version: "1.0", Functions: []FunctionSignature{{FunctionName: "One"}, {FunctionName: "Two"}, {FunctionName: "Three"}, {FunctionName: "Four"}, {FunctionName: "Five"}}}}},
	}
